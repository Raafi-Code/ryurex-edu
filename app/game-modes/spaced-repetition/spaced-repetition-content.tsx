...
export default function SpacedRepetitionContent() {
  ...
  const handleSubmit = () => {
    ...
    const currentWord = words[currentIndex];
    const isCorrect = isAnswerCorrect(userAnswer, currentWord.english_primary, currentWord.synonyms);
    ...
    <div className="min-h-screen bg-background">
      ...
      {showResultModal && (
        <GameResultModal
          ...
          showPlayAgain={true}
          showBackToCategory={!!categoryFilter}
        />
      )}
    </div>
  );
